const fs = require('fs');
const required = ['مولد عروض نهر','Google Sheet','استخدم بيانات تجريبية','ولّد نظرة الشركة والعرض','companyOverview','avgSalary','monthlyHours','buildEconomicImpact','Power BI style visuals','التكلفة المالية للهدر','buildDeepDiagnostics','القراءة التشخيصية للبيانات','حجم الفرصة بأدنى تقدير'];
