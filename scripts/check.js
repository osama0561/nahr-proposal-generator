const fs = require('fs');
const required = ['مولد عروض نهر','Google Sheet','استخدم بيانات تجريبية','ولّد نظرة الشركة والعرض','companyOverview','avgSalary','monthlyHours','buildEconomicImpact','requestAiWasteEstimate','تقدير AI مقابل رأي الموظفين','Power BI style visuals','التكلفة المالية للهدر','trainingPrice','سعر التدريب المقترح','قاعدة التسعير','buildDeepDiagnostics','القراءة التشخيصية للبيانات','حجم الفرصة بأدنى تقدير'];
